...
Se observan dos raices, una en el intervalo $[-4;-2.5]$ y otra en $[1;2.5]$  \

Tomo $p_0 = 1$
```{r método ejercicio 5.1}
this_could_go_wrong <- tryCatch(
...
Tomo $p_0 = -2.5$
```{r método ejercicio 5.1b}
this_could_go_wrong <- tryCatch(
  PuntoFijo(p0 = -2.5, tol = 0.001),
  error = function(e){print("Error")})
